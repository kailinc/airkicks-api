...
ActiveRecord::Schema.define(version: 20170813181911) do
  ...
  create_table "connects", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["collection_id"], name: "index_connects_on_collection_id", using: :btree
    t.index ["shoe_id"], name: "index_connects_on_shoe_id", using: :btree
  ...
  add_foreign_key "connects", "collections"
  add_foreign_key "connects", "shoes"
